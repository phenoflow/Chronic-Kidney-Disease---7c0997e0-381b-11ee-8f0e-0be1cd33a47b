...
steps:
  ...
  chronic-renal-failure-chronic-kidney-disease-ckd---primary:
    run: chronic-renal-failure-chronic-kidney-disease-ckd---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: chronic-renal-failure-chronic-kidney-disease-ckd---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
